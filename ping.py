...
"""
    ...
    November 23, 2017
    ------------------
    Little modifications by Do Le Quoc:
     -  Converted this library into valid Python 3.x code
     -  Used UDP to transfer ICMP messages to ignore root permission

"""

__version__ = "0.2.1" #modified for python3
